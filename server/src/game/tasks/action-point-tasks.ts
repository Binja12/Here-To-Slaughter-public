...
// and so never reaches the turn it was won on; Mega Slime's extra point on
// each turn you take starts with the turn that slays it (the owner, 2026-09-04),
// so the entry grants the first point itself and the effect carries the rest.
// ---------------------------------------------------------------------------
