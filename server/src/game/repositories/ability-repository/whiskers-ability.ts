...
// happen.
//
// The destroy MAY name the hero being stolen — the card says "STEAL a Hero
// card and DESTROY a Hero card", not two different ones, and by the time the
// destroy runs the stolen hero is in this party. Fluffy excludes its first
// pick because "DESTROY 2 Hero cards" is two cards; this is not.
