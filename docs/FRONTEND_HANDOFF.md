...
production quality. **Do not modify the game engine**
...
(`client/public/board/board-bg.png`, 1672x941).
The Tailwind-drawn
...
### Environment gotchas
- Node.js v24 is required. If a shell
  can't find npm:
  make sure Node's install directory is on PATH.
